...
<?php } else if ($this->_rootref['S_FRONTEND']) {  ?>
	...
	<?php if (sizeof($this->_tpldata['sitesplat_themes'])) {  $this->_tpl_include('sitesplat_update_manager.html'); } if ($this->_rootref['S_STYLE']) {  $this->_tpldata['DEFINE']['.']['COLSPAN'] = 5; } else { $this->_tpldata['DEFINE']['.']['COLSPAN'] = 4; } ?>
